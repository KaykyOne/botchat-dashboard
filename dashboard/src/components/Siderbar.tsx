...
export default function Siderbar({ leads, setLead, setModalOpen, activeLeadId }: SiderbarProps) {
  ...
  return (
    ...
    >
      ...
      <div className="flex w-full flex-col border-r border-white/6 bg-[#121212] md:max-w-[380px]">
        ...
        <div className="flex gap-2 overflow-x-auto border-b border-white/6 px-6 py-4 no-scrollbar">
          {filtros.map((item, index) => (
            <button
              ...
              className={`rounded-full border px-3 py-2 text-[11px] font-medium uppercase tracking-[0.08em] transition duration-200 ${
                filtro === index
